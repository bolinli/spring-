...
public class BeanDefinitionParserDelegate {
	...
	public AbstractBeanDefinition parseBeanDefinitionElement(
		...
		try {
			//创建用来承载属性的AbstractBeanDefinition类型的GenericBeanDefinition
	...
	public Object parsePropertyValue(Element ele, BeanDefinition bd, @Nullable String propertyName) {
		...
		//解析ref属性 使用RuntimeBeanReference封装的ref属性
		if (hasRefAttribute) {
		...
		//解析value属性 使用TypedStringValue封装
		else if (hasValueAttribute) {
			TypedStringValue valueHolder = new TypedStringValue(ele.getAttribute(VALUE_ATTRIBUTE));
			valueHolder.setSource(extractSource(ele));
			return valueHolder;
		}
		//解析子元素 例如<constructor-arg><map> </map></constructor-arg>
	...
	public BeanDefinitionHolder decorateIfRequired(
		...
		//获取自定义标签的命名空间,判断是否适用于自定义标签的解析条件
